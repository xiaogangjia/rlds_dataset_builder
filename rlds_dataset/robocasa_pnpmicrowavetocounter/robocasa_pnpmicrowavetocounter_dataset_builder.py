...
raw_data_path = os.path.join("/hkfs/work/workspace/scratch/ll6323-david_dataset_2/robocasa_datasets/v0.1/single_stage", "kitchen_pnp/PnPMicrowaveToCounter/2024-04-26/processed_demo_128_128.hdf5") #"/mnt/d/kit/masterarbeit/processed_demo_128_128.hdf5"
...
if __name__ == "__main__":
    folder_path = os.path.join("/hkfs/work/workspace/scratch/ll6323-david_dataset_2/robocasa_datasets/v0.1/single_stage", "kitchen_pnp/PnPMicrowaveToCounter/2024-04-26/processed_demo_128_128.hdf5") #"/mnt/d/kit/masterarbeit/processed_demo_128_128.hdf5"
